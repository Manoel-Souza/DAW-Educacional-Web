 ...
 * @author Manoel Souza 
 */
@FacesConverter(value = "converterEspecialidades")
public class ConverteEspecialidades implements Serializable, Converter{
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String string) {
        if(string == null || string.equalsIgnoreCase("Selecione um registro")){
            ...
            return EntityManagerUtil.getEntityManager().find(Especialidades.class, 
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object o) {
        if(o == null)
            return  null;
        Especialidades c = (Especialidades) o;
